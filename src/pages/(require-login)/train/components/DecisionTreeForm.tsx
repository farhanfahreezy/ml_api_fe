...
interface DecisionTreeFormProps {
  form: UseFormReturn<DecisionTreeParameterOptimization>;
  onSubmit: (data: DecisionTreeParameterOptimization) => void;
}

interface ParameterFormProps {
  control: Control<DecisionTreeParameterOptimization>;
  name: keyof DecisionTreeParameterOptimization;
}

const DecisionTreeForm = ({ form, onSubmit }: DecisionTreeFormProps) => {
  return (
    <Form {...form}>
      <form
      ...
      >
        <div className="space-y-2 w-full">
          ...
          <ParameterForm control={form.control} name={"splitter"} />
